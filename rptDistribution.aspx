<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Distributor.Master" AutoEventWireup="true" CodeBehind="rptDistribution.aspx.cs" Inherits="e_ration_card.rptDistribution" %>
    ...
    <div style="margin-left: 15%; padding: 1px 16px; height: 100%; margin-top: 0px;"> 
       <%-- <div id="addmember1" class="row bg-light mb-3 border:solid" runat="server" >
        ...
        <div class="col-lg-1 col-xl-1 col-md-1 col-sm-12 col-12 pl-0 pr-0">
          ...
          <div class="col-lg-1 col-xl-1 col-md-1 col-sm-12 col-12 pl-0 pr-0">
                  <asp:Label ID="lblkotedarno" runat="server" Text="Date:"></asp:Label>               
                
                 </div> 
              <div class="col-lg-2 col-xl-2 col-md-2 col-sm-12 col-12 pl-0 pr-0"> 
                 <input type="date" name="dob" class="form-control" id="txtdate" runat="server" />
                 </div>
              <div class="col-lg-2 col-xl-2 col-md-2 col-sm-12 col-12 pl-0 pr-0"> 
